...
\subsubsection*{Recommended Sensors and Placement (with datasheets/CAD)}
\begin{itemize}[noitemsep]
  \item \textbf{Door cylinder end-position (Open/Closed):} T-slot magnetic reed switch.
    \begin{itemize}[noitemsep]
      \item Example: Festo SMT-8M-A-PS-24V-E-0.3-M8D (PNP, 24 VDC).
      \item Placement: one near each end of the door cylinder barrel (slide into T-slot and secure).
      \item Datasheet: \href{https://www.festo.com/us/en/p/smt-8m-a-ps-24v-e-0-3-m8d-id_VAEM_EU/en/}{Festo product page}
      \item 3D model (STEP): on same page under CAD/Downloads.
    \end{itemize}
  \item \textbf{IR through-beam across doorway (obstruction):} Compact photoelectric pair.
    \begin{itemize}[noitemsep]
      \item Example: Omron E3Z-T81 (TX) + E3Z-R81 (RX), PNP, 24 VDC, 15 m.
      \item Placement: TX on one door post, RX directly opposite on the other; beam centered ~900–1100 mm above floor.
      \item Datasheet: \href{https://assets.omron.eu/downloads/datasheet/en/v4/e3z_datasheet_en.pdf}{E3Z datasheet}
      \item 3D model (STEP): \href{https://industrial.omron.eu/en/products/e3z}{Omron E3Z page} (CAD/3D tab).
    \end{itemize}
  \item \textbf{Metro slider end-position (Extended/Retracted):} M8 flush inductive proximity, PNP NO, 24 VDC.
    \begin{itemize}[noitemsep]
      \item Example: ifm IF5711 (M8, 2 mm, PNP NO).
      \item Placement: fixed to frame; sense a steel target on slider bracket at both ends.
      \item Datasheet: \href{https://www.ifm.com/us/en/product/IF5711}{ifm IF5711}
      \item 3D model (STEP): same page, “CAD/3D” download.
    \end{itemize}
  \item \textbf{Lock solenoid end-of-stroke confirm:} Compact lever microswitch.
    \begin{itemize}[noitemsep]
      \item Example: Omron SS-5GL2 (lever, NC/NO).
      \item Placement: mount so the lock pawl flags the lever at the fully engaged position.
      \item Datasheet: \href{https://omronfs.omron.com/en_US/ecb/products/pdf/en-ss.pdf}{Omron SS series datasheet}
      \item 3D model (STEP): \href{https://www.traceparts.com/en/product/omron-ss-5gl2?CatalogPath=TRACEPARTS%3ATP01004001001}{TraceParts model}
    \end{itemize}
  \item \textbf{Optional safety upgrade (instead of single IR beam):} Safety light curtain.
    \begin{itemize}[noitemsep]
      \item Example: SICK deTec4 Core (Type 4).
      \item Placement: span the doorway opening; wire to safety relay.
      \item Datasheet: \href{https://cdn.sick.com/media/docs/1/11/811/Data_sheet_deTec4_Core_en_im0052811.pdf}{SICK deTec4 Core datasheet}
      \item 3D model (STEP): \href{https://www.sick.com/ag/en/detection-and-ranging-solutions/safety-light-curtains/detec4-core/c/g323923}{SICK product page}
    \end{itemize}
\end{itemize}
\textit{Notes: 24 VDC supply, choose PNP vs NPN to match controller. Use shielded cable for IR/analog lines and provide proper strain relief.}
